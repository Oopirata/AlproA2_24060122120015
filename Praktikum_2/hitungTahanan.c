...
int main(){
    ...
    if (  (scanf("%d", &NoTahanan1)) && (scanf("%d", &NoTahanan2)) && (scanf("%d", &NoTahanan3))  ){
        if (NoTahanan1 >=0 && NoTahanan2 >=0 && NoTahanan3 >=0){
            printf("%d",NoTahanan1 + "%d",NoTahanan2 + "%d",NoTahanan3);
            } 
        else {
        ...
        printf("Masukkan tahanan harus bilangan bulat positif");
    }
    return 0;
